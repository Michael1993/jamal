...
public class TestProcessor {
    ...
    public void getFirstMacro() throws BadSyntaxAt {
        final Input input = new Input("this is the body of the macro}");
        final Processor sut = new Processor("{", "}");
        final String result = sut.getNextMacroBody(input);
    ...
    public void unterminated() {
        final Input input = new Input("this is the body of the macro unterminated");
        final Processor sut = new Processor("{", "}");
    ...
    public void getSecondMacro() throws BadSyntaxAt {
        final Input input = new Input("this is the {body} of the macro}{this is the second macro}");
        final Processor sut = new Processor("{", "}");
    ...
    public void simpleDefine() throws BadSyntax {
        final Input input = new Input("{@define q=zqqz}{q}");
        final Processor sut = new Processor("{", "}");
        final String result = sut.process(input);
    ...
    public void testSimpleDefineWargs() throws BadSyntax {
        final Input input = new Input("{@define q(a,b)=abba}{q/z/q}");
        final Processor sut = new Processor("{", "}");
        final String result = sut.process(input);
        Assertions.assertEquals("zqqz", result);
    }
    ...
    public void testNestedDefine() throws BadSyntax {
        final Input input = new Input("{#define b=b}{#define q=zqq{#define b=z}{b}}{q}{b}");
        final Processor sut = new Processor("{", "}");
        final String result = sut.process(input);
    ...
    public void testNestedDefineLateVerbatim() throws BadSyntax {
        final Input input = new Input("{#define b=b}{@define q=zqq{}{b}}{@verbatim q}{b}");
        final Processor sut = new Processor("{", "}");
        final String result = sut.process(input);
    ...
    public void testComment() throws BadSyntax {
        final Input input = new Input("{#define b=b}{@comment {@define q=zqq{}{b}}}{b}");
        final Processor sut = new Processor("{", "}");
        final String result = sut.process(input);
    ...
    public void testVerbatimUdMacroUse() throws BadSyntax {
        final Input input = new Input("{@define b={zz}}{@verbatim b}");
        final Processor sut = new Processor("{", "}");
        final String result = sut.process(input);
